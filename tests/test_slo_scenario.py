...
def test_run_slo_scenario_returns_result():
    ...
    result = run_slo_scenario(profile, seed=42, rate=500.0, calibration_duration=5.0, post_disturbance=10.0)
...
def test_disturbance_elevates_latency_on_low_variance_profile():
    ...
    profile = LATENCY_VARIANCE_SPECTRUM[0]
    result = run_slo_scenario(profile, seed=42, rate=500.0, calibration_duration=5.0, post_disturbance=15.0)
